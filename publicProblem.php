...
>
              ...
              <?php
                ...
                if($page >1){
                  echo  '<li class = ".$active."><a href ="publicProblem.php?page='.($page- 1).'">Previous</a></li>';
                  echo  '<li>-</li>';
                }
                for($i = 1; $i <=$total_page; $i++){
                  ...
                  echo '<li class = ".$active."><a href ="publicProblem.php?page='.$i.'">'.$i.'</a></li>';
                  echo  '<li>-</li>';
                  
                }
                if($total_page >$page){
                  echo  '<li class = ".$active."><a href ="publicProblem.php?page='.($page+ 1).'">Next</a></li>';
